...
public partial class NetworkDebug : Control
{
    ...
    {
        ServerTick.Text = "Server Tick " + (NetworkManager.AmIClient ? NetworkTime.TickMS.ToString() : NetworkTime.TickMS.ToString());
        ...
        RTTLabel.Text = (NetworkTime.RTT.Value / 2).ToString() + " MS";
